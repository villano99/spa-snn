...
class GraphSNN(nn.Module):
    def __init__(self, input_size=(2, 128, 128), num_classes=4, 
        ...
        # --- Layer 1: Local Connectivity (Input -> L1) ---
        # Grid Size: We divide image into cells.
        # If input is 128x128, and we want L1 to cover it.
        # Original logic: Cell grid was implied by `generate_input_masks`.
        # Here we make it resolution-agnostic.
        # Let's assume L1 has N neurons spatially distributed?
        # Or L1 is fully connected? No, huge.
        # Approach: Random Graph with Local Masks.
        
        # Number of L1 neurons: H * W / (stride^2) * l1_per_cell ?
