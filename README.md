...
Download **DailyAction-DVS** from the [official source](http://www2.eecs.berkeley.edu/Research/Projects/CS/vision/shape/). Then convert to HDF5 with strict LOSO split:
